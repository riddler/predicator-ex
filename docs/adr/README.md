...
| [0016](https://github.com/riddler/predicator-ex/blob/main/docs/adr/0016-predicator-emits-no-telemetry.md) | Predicator emits no telemetry; the event contract is reserved, not shipped | proposed |
